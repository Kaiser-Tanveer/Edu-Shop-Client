...
const Product = ({ product }) => {
    ...
    return (
        <div className='relative rounded-lg bg-cyan-200 shadow-lg group-hover:cursor-pointer group-hover:blur-sm group-hover:scale-90 hover:!blur-none hover:!scale-100 duration-500'>
